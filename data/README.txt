...
* Add Group: Create a new selection group.
* Delete Group: Remove the selected group.
* Save Group: Save data of all groups to TF2CM's config.
...
How To Use
----------
1. Click "Add Group" to create a new selection group.
2. Edit the group name.
3. Select any map you wanna queue.
4. Click "Save Group" to save changes.
...
7. Find your casual game like normal.

Tech Details
------------
TF2CM edits casual_criteria.vdf in tf folder, this is the map selection save file, which is a plain text file. It's VAC safe to edit it when TF2 is open.
